...
## [Service Management (systemd)](./linux.html#-service-management-systemd)
  ...
  - [1️⃣ Start a Service](./linux.html#1️⃣-start-a-service)
  - [2️⃣ Stop a Service](./linux.html#2️⃣-stop-a-service)
  - [3️⃣ Restart a Service (VERY COMMON)](./linux.html#3️⃣-restart-a-service-very-common)
  - [4️⃣ Reload a Service](./linux.html#4️⃣-reload-a-service)
  - [5️⃣ Check Service Status ⭐ (MOST IMPORTANT)](./linux.html#5️⃣-check-service-status--most-important)
  - [6️⃣ Enable Service at Boot (AWS CRITICAL)](./linux.html#6️⃣-enable-service-at-boot-aws-critical)
  - [7️⃣ Disable Service at Boot](./linux.html#7️⃣-disable-service-at-boot)
  - [8️⃣ Start + Enable Together](./linux.html#8️⃣-start--enable-together)
  - [9️⃣ List All Services](./linux.html#9️⃣-list-all-services)
  - [🔟 Check if Service is Enabled](./linux.html#-check-if-service-is-enabled)
  - [1️⃣1️⃣ Check if Service is Active](./linux.html#1️⃣1️⃣-check-if-service-is-active)
  - [1️⃣2️⃣ View Service Logs (AWS Debugging)](./linux.html#1️⃣2️⃣-view-service-logs-aws-debugging)
  - [1️⃣3️⃣ Common AWS Services \& Names](./linux.html#1️⃣3️⃣-common-aws-services--names)
  - [1️⃣4️⃣ Real AWS EC2 Examples 🔥](./linux.html#1️⃣4️⃣-real-aws-ec2-examples-)
  - [1️⃣6️⃣ systemd Files (High Level – Exam Only)](./linux.html#1️⃣6️⃣-systemd-files-high-level--exam-only)
  - [1️⃣7️⃣ systemd vs init (Interview / Exam)](./linux.html#1️⃣7️⃣-systemd-vs-init-interview--exam)
